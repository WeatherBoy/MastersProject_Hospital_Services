...
{
    name=dictionary,
    description={When we refer to a dictionary, we mean a data structure which solves the dictionary problem. This can often simply be thought of as a hash map}
}
