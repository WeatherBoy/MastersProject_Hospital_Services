...
\newacronym{ouh}{OUH}{University Hospital of Odense}
...
\newacronym{bsat}{BSAT}{Boolean Satisfiability (problem)}
...
\newacronym{dpll}{DPLL}{Davis, Putnam, Logemann, and Loveland('s algorithm)}

\newacronym{cdcl}{CDCL}{Conflict-Driven Clause Learning}


% Formalia goes here:
\newcommand\datoen{March 9, 2025} %<--- Dato
...
\begin{document}
    ...
    \include{sections/5_analysis.tex}
