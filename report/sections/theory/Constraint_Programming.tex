...
\begin{equation*}
    A \vee (B \wedge C).
\end{equation*}
And as per the final part of definition 2.1, the negation boolean operator must apply solely to an atom, making it literal. Hence, it is necessary to propagate negations inwards (to the atomic level).
\begin{enumerate}
