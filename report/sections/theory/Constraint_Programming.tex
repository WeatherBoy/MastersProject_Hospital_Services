...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        ...
        \subcaption{Step 3: Next, when we try to assign \texttt{False} to \(p_2\), we get a conflict.}
    \end{subfigure}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        ...
        \subcaption{Step 4: We backtrack and try \texttt{True} for \(p_2\).}
    \end{subfigure}
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/Constraint-Programming/DPLL-Toy-Example6.png}
        \subcaption{Step 5: Finally, when we assign \texttt{True} to \(p_1\), we have a satisfying assignment.}
    \end{subfigure}
\end{figure}
