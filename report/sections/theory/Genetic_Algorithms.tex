...
\paragraph{Linear Rank Selection} assigns fitness to a rank linearly. It introduces a kind of temperature parameter called Selection Pressure, $sp \in [1,2]$, emphasising how much priority a greater rank has. It is formally expressed as 
\begin{equation*}
...
\begin{figure}[H]
    ...
    \caption{Rank Selection - Visualisation}
    \small
    \raggedright
    The effect of varying the Selection Pressure in Linear Rank Selection and the Weight in Exponential Rank Selection. Both methods are used on the rankings $\{1, 2, \hdots , 10\}$. 
